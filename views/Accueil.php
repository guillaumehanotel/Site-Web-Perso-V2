        ...
        <div class="expe">
            ...
            <div id="content">
                <div class="row valign-wrapper">
                    ...
                    <p id="date" class="col l3 offset-l1 m3  s12">Juillet - Aout 2016
                        <br>(2 mois)</p>
                </div>
                <div class="row">
