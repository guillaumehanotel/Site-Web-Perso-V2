...
<main id="accueil">
    <div id="section0" class="section">
        ...
        <div id="apropos" class="dividera"></div>
    ...
    <!-- ======= REALISATIONS ========= -->
    <div id="section2" class="section greyy">
       <div class="container">
        <h2 id="titre2">REALISATIONS</h2>
        <div id="toplink2" class="toplink"></div>
        <div id="lien2" class="lien"></div>
        <div class="row">
            <?php
    ...
    <div id="section3" class="section ">
        ...
        <div id="row_skill" class="row">
            ...
            <div class="tab_skill col l3 m3 s8 offset-l1 offset-m1 offset-s2">
                <div class="title_skill">
                    <h6 class="">Ce que je maîtrise correctement :</h6> </div>
                <?php
            ...
            <div class="tab_skill col l3 m3 s8 offset-l1 offset-m1 offset-s2">
                <div class="title_skill">
                    <h6 class="">Ce que je maîtrise moyennement :</h6> </div>
                <?php
    ...
    <!-- ======= FORMATIONS ========= -->
    <div id="section4" class="section greyy">
       <div class="container">
        <h2 id="titre4">FORMATIONS</h2>
        <div id="toplink4" class="toplink"></div>
        <div id="lien4" class="lien"></div>
        ...
        <div class="row">
            ...
            ?>
                <div id="card" class="card">
                    ...
                    <div class="card-action"> <a href="<?= $value['formation_lien'] ?>" class="black-text" target="_blank">Lien de la formation</a> </div>
                </div>
                <?php
                }
            ?>
    ...
    <div id="section5" class="section container">
        ...
        <div id="lien5" class="lien"></div>
        <!-- Token Error  -->
        <?php
            if(isset($token_error) && $token_error == true){
        ?>
            <div hidden="hidden" id="token_error" class="token">
                <?= $_SESSION["erreur"] ?>
            </div>
            <?php
            }
        ...
        ?>
                <div class="row">
                    <div class="center-align col s4"> <a target="_blank" href="https://github.com/guillaumehanotel"><i class="fa fa-github fa-5x" aria-hidden="true"></i></a></div>
                    <div class="center-align col s4"> <a target="_blank" href="https://twitter.com/GHanosql"><i class="fa fa-twitter fa-5x" aria-hidden="true"></i></a> </div>
                    <div class="center-align col s4"> <a target="_blank" href="https://www.linkedin.com/in/guillaume-hanotel-538b81106"><i class="fa fa-linkedin fa-5x" aria-hidden="true"></i></a> </div>
                </div>
                <div class="row">
                    <form method="post" action="" class="col l8 s12 offset-l2">
                        ...
                        <div class="row">
                            <input id="submit_mail" name="mail" class="btn col m4 s8 offset-m4 offset-s2" type="submit" value="Envoyer" /> </div>
                    </form>
                </div>
    </div>
</main>
<footer class="page-footer">
    <div class="footer-copyright">
        <div class="container"> © 2017 Guillaume HANOTEL </div>
    </div>
</footer>
</body>
